...
const depositNotificationSchema = new mongoose_1.Schema({
    ...
    depositId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Deposit', required: true },
...
exports.DepositNotification = mongoose_1.default.model('DepositNotification', depositNotificationSchema);
